    ...
    <div class="col-lg-10 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a style="max-width: 150px; float:right;display: inline-block;" href="{{ url('admin/add-edit-section') }}" class="btn btn-block btn-primary">Thêm Sản Phẩm</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td>
                                ...
                                <a class="updateSection" id="section-{{ $sectionList['id'] }}" section_id={{ $sectionList['id'] }}
                               ...
                               <th>
                                ...
                                {{-- <a title="sản phẩm" class="confirm-section"" href={{ url('admin/delete-section/'.$sectionList['id']) }}>
                                <i style="font-size: 25px" class="mdi mdi mdi-delete-sweep"></i></a> --}}
                                <a href="javascript:void(0)" class="confirm-section" module="section" moduleid="{{ $sectionList['id'] }}">
                                    <i style="font-size: 25px" class="mdi mdi mdi-delete-sweep"></i></a>
                            </th>
                            </tr>
                            @endforeach
