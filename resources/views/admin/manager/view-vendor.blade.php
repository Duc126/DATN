                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ old('address_proof', $vendor['vendor_business']['address_proof'] ?? null) }}"
                                            ...
                                            {{-- <option value="Passpost" @if ($vendor['vendor_business']['address_proof'] == 'Passpost') selected @endif>
                                                ...
                                                value="D">D</option>
                                                <option {{ old('address_proof', $vendor['vendor_business']['address_proof'] ?? null) == 'E' ? 'selected' : '' }}
                                                value="E">E</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ old('pan_number', $vendor['vendor_business']['pan_number'] ?? null) }}"
                                            ...
                                            {{-- value="{{ $vendor['vendor_business']['pan_number'] }}" --}}
                                            id="pan_number"
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ old('gst_number', $vendor['vendor_business']['gst_number'] ?? null) }}"
                                            ...
                                            {{-- value="{{ $vendor['vendor_business']['gst_number'] }}" --}}
                                            id="gst_number"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('account_holder_name', $vendor['vendor_bank']['account_holder_name'] ?? null) }}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="account_number" class="form-control"
                                            name="account_number"
                                        value="{{ old('account_number', $vendor['vendor_bank']['account_number'] ?? null) }}" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        value="{{ old('bank_name', $vendor['vendor_bank']['bank_name'] ?? null) }}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        value="{{ old('bank_ifsc_code', $vendor['vendor_bank']['bank_ifsc_code'] ?? null) }}" readonly>
