                            ...
                            @else action="{{ url('admin/add-edit-product/' . $product['id']) }}" @endif
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="product_code"
                                                placeholder="Nhập Tên Sản Phẩm" name="product_code"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="product_color"
                                                placeholder="Nhập Tên Sản Phẩm" name="product_color"
                                                @if (!empty($product['product_color'])) value="{{ $product['product_color'] }}" @else value="{{ old('product_color') }}" @endif>
                                        </div>
                                        <div class="form-group">
                                            <label for="product_price">{{ __('Product Price ') }}<span
                                                    class="text-danger">*</span> :</label>
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="product_image">{{ __('Danh Mục Hình Ảnh (Kích thước ảnh: 1000x1000)') }}<span
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                for="product_video">{{ __('Danh Mục Video (Kích thước video: Ít hơn 2MB )') }}<span
                                                    class="text-danger">*</span>
                                                :</label>
                                        ...
                                        <div class="form-group">
                                            <label for="is_bestseller">Best Seller
                                            </label>
